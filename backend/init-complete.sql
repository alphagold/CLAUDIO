...
CREATE TABLE IF NOT EXISTS users (
    ...
    auto_rewrite_enabled BOOLEAN DEFAULT TRUE NOT NULL,
    self_person_id UUID,
...
(
    'completo',
    'Full analysis: objects, environment, colors, text (default without faces)',
    'Analyze this image extracting as much information as possible.{location_hint}{datetime_hint}{faces_hint}
...
(
    'focus_persone',
    'Focus on people: physical appearance, expressions, clothing, actions (auto with faces)',
    'Analyze this photo focusing on the people present.{location_hint}{datetime_hint}{faces_hint}
...
(
    'focus_scena',
    'Focus on environment and objects: place, furnishings, details, atmosphere',
    'Analyze this photo focusing on the environment and objects.{location_hint}{datetime_hint}{faces_hint}
